...
class AIChatService {
  final _random =
      DateTime.now().millisecondsSinceEpoch; // For deterministic responses
  ...
  ChatNotifier(this._aiService)
      : super([
          ChatMessage(
            id: 'welcome-message',
            content:
                'Hello! I\'m CookMate AI, your personal cooking assistant. How can I help you with your cooking today?',
